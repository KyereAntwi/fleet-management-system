        ...
        <Accordion defaultIndex={[0]} allowMultiple w={"full"}>
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              >
                <GridItem h={"full"}>
                  <VehiclesDueForRoadworthyRenewalReportWidget
                    workspaceId={workspaceId!}
                    period={"current"}
                  />
                </GridItem>
                ...
                <GridItem h={"250px"}>
                  <VehicleDueForInsuranceRenewalReportWidget
                    workspaceId={workspaceId!}
                    period={"current"}
                  />
                </GridItem>
            ...
            <AccordionPanel pb={4}>
              <>
                ...
                >
                  ...
                  <GridItem h={"full"}>
                    <TotalCostOfAccidentRepairsReportWidget
                      workspaceId={workspaceId!}
                      fromDate={fromDate}
                      toDate={toDate}
                    />
                  ...
                  <GridItem h={"full"}>
                    <TotalCostOfFuelConsumedReportWidget
                      workspaceId={workspaceId!}
                      fromDate={fromDate}
                      toDate={toDate}
                    />
                  ...
                  <GridItem h={"full"}>
                    <TotalCostOfMaintenanceReportWidget
                      workspaceId={workspaceId!}
                      fromDate={fromDate}
                      toDate={toDate}
                    />
